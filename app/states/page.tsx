      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-10 space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <div className="rounded-xl border border-gray-200/50 dark:border-gray-700/50 bg-white dark:bg-gray-900 p-4">
            ...
            >
              <SelectItem key="region">Region (Default)</SelectItem>
              <SelectItem key="capacity">Capacity (High/Medium/Low)</SelectItem>
              <SelectItem key="resources">Resources Available</SelectItem>
            </Select>
          </div>
          ...
          <div className="rounded-xl border border-gray-200/50 dark:border-gray-700/50 bg-white dark:bg-gray-900 p-4">
            ...
            <div className="grid grid-cols-2 gap-2">
              {['Oil', 'Steel', 'Rare Earth', 'Copper', 'Fertile Land', 'Lumber', 'Chemical Compounds'].map(resource => (
                <Checkbox
                  key={resource}
                  isSelected={selectedResources.has(resource)}
            ...
            {selectedResources.size > 0 && (
              <Button
                onPress={() => setSelectedResources(new Set())}
                variant="light"
                color="primary"
                size="sm"
                className="mt-2"
