...
export default function AdminPage() {
  ...
  const handleDeploy = async () => {
    ...
    try {
      ...
      const errorResult = {
        success: false,
        message: err?.response?.data?.error || 'Deployment failed',
              ...
              <div className="p-4 rounded-lg bg-gradient-to-r from-purple-50 to-pink-50 dark:from-purple-900/20 dark:to-pink-900/20 border-2 border-purple-200 dark:border-purple-700">
                <div className="flex items-start justify-between mb-4">
                  ...
                  <button
                    ...
                    className="flex items-center gap-2 px-4 py-2 text-sm font-medium rounded-md bg-gradient-to-r from-purple-600 to-pink-600 text-white hover:from-purple-700 hover:to-pink-700 disabled:opacity-50 disabled:cursor-not-allowed shadow-lg"
                  >
                    {deploymentLoading ? (
                      <>
                        <div className="w-4 h-4 border-2 border-white border-t-transparent rounded-full animate-spin" />
