...
export default function TooltipPanel({ children, className }: Props) {
  return (
    <div className={`absolute bottom-full left-1/2 -translate-x-1/2 mb-2 opacity-0 group-hover:opacity-100 group-focus-within:opacity-100 transition-opacity duration-200 z-[9999] pointer-events-auto ${className || ''}`}>
